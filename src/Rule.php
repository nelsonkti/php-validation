...
use Nelsonkti\Validation\MissingRequiredParameterException;
...
abstract class Rule
{
    ...
    /** @var \Nelsonkti\Validation\Attribute|null */
    protected $attribute;

    /** @var \Nelsonkti\Validation\Validation|null */
     ...
     *
     * @param \Nelsonkti\Validation\Validation $validation
     * @return void
     */
     ...
     * Get attribute
     *
     * @return \Nelsonkti\Validation\Attribute|null
     */
     ...
     *
     * @param array $params
     * @return \Nelsonkti\Validation\Rule
     */
     ...
     * @param array $params
     * @return void
     * @throws \Nelsonkti\Validation\MissingRequiredParameterException
     */
